...
spike.core.Assembler.defineNamespace('spike.core', ['Request_1', 'Request'], function () {
  spike.core.Request_1 = function (config) {
    var $this = this;
  ...
  spike.core.Request_1.prototype = spike.core.Request.prototype;
});
...
spike.core.Assembler.defineNamespace('spike.core', ['Element_2', 'Element'], function () {
  spike.core.Element_2 = function (parentElement, model) {
    var $this = this;
  ...
  spike.core.Element_2.prototype = spike.core.Element.prototype;
});
...
spike.core.Assembler.defineNamespace('spike.core', ['Controller_1', 'Controller_2', 'Controller'], function () {
  spike.core.Controller_1 = function (model) {
    var $this = this;
  ...
  spike.core.Controller_2 = function (model, test) {
    var $this = this;
    console.log('x');
  };
  ...
  spike.core.Controller_1.prototype = spike.core.Controller.prototype;
  spike.core.Controller_2.prototype = spike.core.Controller.prototype;
});
spike.core.Assembler.defineNamespace('spike.core', ['Modal_1', 'Modal'], function () {
  spike.core.Modal_1 = function (model) {
    var $this = this;
  ...
  spike.core.Modal_1.prototype = spike.core.Modal.prototype;
});
...
spike.core.Assembler.dependencies(function () {
  spike.core.Modal_2 = spike.core.Element_2;
  spike.core.GlobalElement_2 = spike.core.Element_2;
  spike.core.Assembler.extend(spike.core.Element.prototype, spike.core.GlobalElement.prototype);
  spike.core.Assembler.extend(spike.core.Element_2.prototype, spike.core.GlobalElement_2.prototype);
  spike.core.Assembler.extend(spike.core.Element.prototype, spike.core.Controller.prototype);
  spike.core.Assembler.extend(spike.core.Element_2.prototype, spike.core.Controller_2.prototype);
  spike.core.Assembler.extend(spike.core.Element.prototype, spike.core.Modal.prototype);
  spike.core.Assembler.extend(spike.core.Element_2.prototype, spike.core.Modal_2.prototype);
});
spike.core.Assembler.setConstructorsMap({
  'spike.core.Config': {'0': 'spike.core.Config',},
  'spike.core.Util': {'0': 'spike.core.Util',},
  'spike.core.Element': {'2': 'spike.core.Element_2', '0': 'spike.core.Element',},
  'spike.core.Templates': {'0': 'spike.core.Templates',},
  'spike.core.LoaderInterface': {'0': 'spike.core.LoaderInterface',},
  'spike.core.EventsInterface': {'0': 'spike.core.EventsInterface',},
  'spike.core.Modal': {'1': 'spike.core.Modal_1', '0': 'spike.core.Modal', '2': 'spike.core.Modal_2',},
  'spike.core.Broadcaster': {'0': 'spike.core.Broadcaster',},
  'spike.core.ModalInterface': {'0': 'spike.core.ModalInterface',},
  'spike.core.Rest': {'0': 'spike.core.Rest',},
  'spike.core.Errors': {'0': 'spike.core.Errors',},
  'spike.core.Events': {'0': 'spike.core.Events',},
  'spike.core.Request': {'1': 'spike.core.Request_1', '0': 'spike.core.Request',},
  'spike.core.Controller': {
    '1': 'spike.core.Controller_1',
    '2': 'spike.core.Controller_2',
    '0': 'spike.core.Controller',
  },
  'spike.core.Router': {'0': 'spike.core.Router',},
  'spike.core.RoutingInterface': {'0': 'spike.core.RoutingInterface',},
  'spike.core.Selectors': {'0': 'spike.core.Selectors',},
  'spike.core.Message': {'0': 'spike.core.Message',},
  'spike.core.GlobalElement': {'0': 'spike.core.GlobalElement', '2': 'spike.core.GlobalElement_2',},
  'spike.core.System': {'0': 'spike.core.System',},
  'spike.core.Log': {'0': 'spike.core.Log',},
});