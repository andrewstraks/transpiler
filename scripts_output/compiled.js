...
extend(spike.core.Element, spike.core.Element);
extend(spike.core.Request, spike.core.Request);
extend(spike.core.Controller, spike.core.Controller);
extend(Element, spike.core.Modal);
extend(spike.core.Modal, spike.core.Modal);